...
module FNSCATF_encoder_core_8(
    ...
    FNSCATF_encoderModule_cmp #(.RES_IN_WIDTH(`VH_FNSCATF_DataInBitWidth_8bitCW), .RES_OUT_WIDTH(`VH_FNSCATF_NSValueMaxBinWidth_P7), .NS_VALUE(`VH_FNSCATF_NSValue_P7)) 
        cmp_module7 (
            .res_in(datain),
            .lock_in(1'b0),
            .q_out(q_out[7]),

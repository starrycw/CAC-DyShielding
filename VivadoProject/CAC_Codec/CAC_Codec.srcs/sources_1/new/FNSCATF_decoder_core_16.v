...
module FNSCATF_decoder_core_16(
    input wire [15 : 0] codein,
    output wire [`VH_FNSCATF_DataInBitWidth_16bitCW - 1 : 0] dataout
    );

    wire [14 : 0] code_q;

    assign code_q[14 : 0] = (codein[15] == 1'b0)? (codein[14 : 0]) : ({1'b0, codein[14 : 1]});
    assign dataout = (codein[15] * `VH_FNSCATF_NSValue_P15) + 
                        (code_q[14] * `VH_FNSCATF_NSValue_P14) + 

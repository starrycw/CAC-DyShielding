...
module FNSCATF_decoder_core_11(
    input wire [10 : 0] codein,
    output wire [`VH_FNSCATF_DataInBitWidth_11bitCW - 1 : 0] dataout
    );

    wire [9 : 0] code_q;

    assign code_q[9 : 0] = (codein[10] == 1'b0)? (codein[9 : 0]) : ({1'b0, codein[9 : 1]});
    assign dataout = (codein[10] * `VH_FNSCATF_NSValue_P10) + 

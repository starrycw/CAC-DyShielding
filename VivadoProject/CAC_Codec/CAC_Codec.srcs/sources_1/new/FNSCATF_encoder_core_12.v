...
module FNSCATF_encoder_core_12(
    input wire [`VH_FNSCATF_DataInBitWidth_12bitCW - 1 : 0] datain,
    ...
    FNSCATF_encoderModule_cmp #(.RES_IN_WIDTH(`VH_FNSCATF_DataInBitWidth_12bitCW), .RES_OUT_WIDTH(`VH_FNSCATF_NSValueMaxBinWidth_P11), .NS_VALUE(`VH_FNSCATF_NSValue_P11)) 
        cmp_module11 (
            .res_in(datain),
            .lock_in(1'b0),
            .q_out(q_out[11]),
    ...
    wire lock_10 = q_out[11] | q_out[10];
    ...
    // Shift
    assign codeout[11] = q_out[11];
    assign codeout[10 : 1] = (q_out[11] == 1'b0)? (q_out[10 : 1]) : (q_out[9 : 0]);
    assign codeout[0] = (q_out[11] == 1'b0)? (q_out[0]) : (1'b0);

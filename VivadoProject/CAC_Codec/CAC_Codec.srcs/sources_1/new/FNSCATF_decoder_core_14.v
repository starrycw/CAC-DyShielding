...
module FNSCATF_decoder_core_14(
    input wire [13 : 0] codein,
    output wire [`VH_FNSCATF_DataInBitWidth_14bitCW - 1 : 0] dataout
    );

    wire [12 : 0] code_q;

    assign code_q[12 : 0] = (codein[13] == 1'b0)? (codein[12 : 0]) : ({1'b0, codein[12 : 1]});
    assign dataout = (codein[13] * `VH_FNSCATF_NSValue_P13) + 

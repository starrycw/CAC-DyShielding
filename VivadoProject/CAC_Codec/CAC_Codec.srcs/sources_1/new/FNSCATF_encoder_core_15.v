...
module FNSCATF_encoder_core_15(
    ...
    FNSCATF_encoderModule_cmp #(.RES_IN_WIDTH(`VH_FNSCATF_DataInBitWidth_15bitCW), .RES_OUT_WIDTH(`VH_FNSCATF_NSValueMaxBinWidth_P14), .NS_VALUE(`VH_FNSCATF_NSValue_P14)) 
        cmp_module14 (
            .res_in(datain),
            .lock_in(1'b0),
            .q_out(q_out[14]),
    ...
    wire lock_13 = q_out[14] | q_out[13];
    ...
    // Shift
    assign codeout[14] = q_out[14];
    assign codeout[13 : 1] = (q_out[14] == 1'b0)? (q_out[13 : 1]) : (q_out[12 : 0]);
    assign codeout[0] = (q_out[14] == 1'b0)? (q_out[0]) : (1'b0);
